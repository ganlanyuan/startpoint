...
// Use placeholder in IE6
!function(e){e.extend(e,{placeholder:{browser_supported:function(){return void 0!==this._supported?this._supported:this._supported=!!("placeholder"in e('<input type="text">')[0])},shim:function(t){var i={color:"#888",cls:"placeholder",lr_padding:4,selector:"input[placeholder], textarea[placeholder]"};e.extend(i,t),!this.browser_supported()&&e(i.selector)._placeholder_shim(i)}}}),e.extend(e.fn,{_placeholder_shim:function(t){function i(i){var s=e(i).offsetParent().offset(),a=e(i).offset();return{top:a.top-s.top+(e(i).outerHeight()-e(i).height())/2,left:a.left-s.left+t.lr_padding,width:e(i).width()-t.lr_padding}}return this.each(function(){var s=e(this);if(s.data("placeholder")){var a=s.data("placeholder");return a.css(i(s)),!0}var o={};s.is("textarea")||"auto"==s.css("height")||(o={lineHeight:s.css("height"),whiteSpace:"nowrap"});var n=e("<label />").text(s.attr("placeholder")).addClass(t.cls).css(e.extend({position:"absolute",display:"inline","float":"none",overflow:"hidden",textAlign:"left",color:t.color,cursor:"text",paddingTop:s.css("padding-top"),paddingLeft:s.css("padding-left"),fontSize:s.css("font-size"),fontFamily:s.css("font-family"),fontStyle:s.css("font-style"),fontWeight:s.css("font-weight"),textTransform:s.css("text-transform"),zIndex:99},o)).css(i(this)).attr("for",this.id).data("target",s).click(function(){e(this).data("target").focus()}).insertBefore(this);s.data("placeholder",n).focus(function(){n.hide()}).blur(function(){n[s.val().length?"hide":"show"]()}).triggerHandler("blur"),e(window).resize(function(){var e=n.data("target");n.css(i(e))})})}})}(jQuery),jQuery(document).add(window).bind("ready load",function(){jQuery.placeholder&&jQuery.placeholder.shim()});
